...
VIT_ARCH = 'ViT-B-16-CLIP-new-new'  # Model Architecture
MODEL_DIR = ''              # Model Directory
CACHE_DIR = ''              # Where to cache HF pretrained checkpoints
HEAD_DIR = ''               # CLIP Head Directory
FT_DIR = ''                 # Fine-tuned LoRA checkpoints directory
...
config = {
    ...
    'model': {
        ...
        'cachedir': CACHE_DIR,
        'bases': [
            # Path to model checkpoints stored locally - rank-16 16 vision tasks
