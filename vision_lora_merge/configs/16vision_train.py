...
VIT_ARCH = 'ViT-B-16-CLIP-new-new'    # Model Architecture (Uncomment for ViT-B-16-CLIP)
# VIT_ARCH = 'ViT-B-32-CLIP-new-new'      # Model Architecture (Uncomment for ViT-B-32-CLIP)
# VIT_ARCH = 'ViT-L-14-CLIP-new-new'    # Model Architecture (Uncomment for ViT-L-14-CLIP)
MODEL_DIR = ''                  # Model Directory
CACHE_DIR = ''                  # Where to cache HF pretrained checkpoints
HEAD_DIR = ''                   # CLIP Head Directory

if VIT_ARCH == 'ViT-L-14-CLIP-new-new':
    BASE_TYPE = "openai/clip-vit-large-patch14"
elif VIT_ARCH == 'ViT-B-16-CLIP-new-new':
    BASE_TYPE = "openai/clip-vit-base-patch16"
elif VIT_ARCH == 'ViT-B-32-CLIP-new-new':
...
config = {
    'dataset': [
        ...
        {
            'name': 'sst2',
            'clip_encodings': os.path.join(HEAD_DIR, VIT_ARCH, 'sst2_head.pt'),
            'val_fraction': 0.2,
            'batch_size': 32,
            'num_workers': 8,
        },
        ...
        {
            'name': 'fer2013',
            'clip_encodings': os.path.join(HEAD_DIR, VIT_ARCH, 'fer2013_head.pt'),
            'val_fraction': 0.2,
            'batch_size': 32,
            'num_workers': 8,
        },
